        ...
        bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (emailString.isEmpty()) {
                    Toast.makeText(wangjimima.this, "邮箱地址不能为空", Toast.LENGTH_SHORT).show();
                } else {
                    AVUser.requestPasswordResetInBackground(emailString, new RequestPasswordResetCallback() {
                        @Override
                        public void done(AVException e) {
                            if (e == null) {
                                Toast.makeText(wangjimima.this, "请至邮箱查看重置密码链接", Toast.LENGTH_SHORT).show();
                                finish();
                            } else if (e.getCode() == 205) {
                                Toast.makeText(wangjimima.this, "该邮箱地址不存在", Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(wangjimima.this, e.toString(), Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
